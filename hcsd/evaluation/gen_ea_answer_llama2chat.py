...
def get_model_answers(
    ...
    for _ in range(3):
        ...
        for j in range(len(question["turns"])):
            ...
            generated_ids = output_ids[:, input_len:]  # 截取用户输入之后的部分
            output = tokenizer.decode(generated_ids[0], skip_special_tokens=True)  # 解码为文本
...
if __name__ == "__main__":
    ...
    parser.add_argument("--draft-model-type", type=str, default="hcsd")
    parser.add_argument(
        "--bench-name",
        type=str,
        default="mt_bench",
