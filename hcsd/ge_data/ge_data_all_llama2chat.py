...
bigname="/gf3/home/lzq/model/Llama-2-7b-chat-hf"
...
def build_dataset_rank(
    ...
    ds = load_dataset('json', data_files="/gf3/home/lzq/DateSet/ShareGPT_V4.3_unfiltered_cleaned_split.json")
    ds = ds['train']
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples['id'])):
            ...
            for i, turn in enumerate(turns):
                ...
                # print("tokenizer(parts[0]).input_ids",tokenizer(parts[0]).input_ids)
